...
export const createInitialState = ({ section }) => ({
  ...
  users: [],
  userSessions: [],
  userSessionsLoaded: false,
  selectedSessions: [],
  sessionFilters: { username: '' },
  config: null,
  settingsForm: null,
  settingsDraftError: '',
  customCSS: null,
  ...
  siteValidation: null,
  section,
  documentEditor: { source_path: '', raw: '', html_body: '', version_comment: '', lock_token: '' },
  documentFieldSchema: [],
  documentFieldValues: {},
  documentContractTitles: [],
  ...
  tables: {
    ...
    sessions: { page: 1, pageSize: 10, sort: 'last_seen', dir: 'desc' },
    ...
    redirects: { page: 1, pageSize: 10, sort: 'from', dir: 'asc' },
  },
  loadErrors: [],
  error: '',
  flash: '',
